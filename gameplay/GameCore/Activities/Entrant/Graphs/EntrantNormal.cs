...
namespace GameCore.Activities.Entrant.Graphs
{
	...
	public class EntrantNormal : Activity
	{
		// Token: 0x060013FC RID: 5116 RVA: 0x0001DE18 File Offset: 0x0001CE18
		protected override WorkflowElement CreateBody()
		{
			...
			PauseDetected activity11 = new PauseDetected(base.InstancedEvent);
			if (base.Entrant.Opponent is LocalHumanOpponent)
			{
				...
				state2.Transitions.Add(new Transition("aborted", activity11));
			...
			if (base.Entrant.Opponent is LocalHumanOpponent)
			{
				...
				WrongWayNotification activity12 = new WrongWayNotification(base.InstancedEvent, base.Entrant);
				NavigateToGPSUpdater activity13 = new NavigateToGPSUpdater(base.InstancedEvent, base.Entrant, Ports.Gameplay);
				...
				PostEventScreen activity14 = new PostEventScreen(base.InstancedEvent, base.Entrant, Ports.Gameplay);
				AbortEvent item24 = new AbortEvent(base.InstancedEvent);
				LobbyTick activity15 = new LobbyTick(0.25f);
				state5.Transitions.Add(new Transition(activity15));
				state5.Transitions.Add(new Transition("done", activity14));
